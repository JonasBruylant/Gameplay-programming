...
void App_GraphTheory::Start()
{
	...
	m_pGraph2D = new Graph2D<GraphNode2D, GraphConnection2D>(false); //Paramater is for deciding if it's directional or not.
...
void App_GraphTheory::Update(float deltaTime)
{
	...
	auto graphPath = eulerFinder.FindPath(eulerianity);
	switch (eulerianity)
	{
